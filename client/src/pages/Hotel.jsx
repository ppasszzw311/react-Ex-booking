...
const Hotel = () => {
  ...
  const [openSider, setOpenSlider] = useState(false);
  ...
  const silderDirection = (direction) => {
    let newSliderIndex;
        ...
        <div className='slider'>
          <div className='sliderWrapper'>
            ...
            <div className='wrapperBody'>
              <FontAwesomeIcon icon={faAngleLeft} className="arrow" onClick={() => silderDirection("left")} />
              <img src={photos[sliderIndex].src} alt="" />
              <FontAwesomeIcon icon={faAngleRight} className="arrow" onClick={() => silderDirection("right")} />
            </div>
          </div>
        </div>
      }
        ...
        <div className='HotelWrapper'>
          ...
          <div className='title'>
            <div className='titleLeft'>
              ...
              <span className='recommend'><span className='remmendSvg'><FontAwesomeIcon icon={faPeopleGroup} /></span>推薦四人住宿</span>
              <div className='address'><FontAwesomeIcon icon={faLocationDot} />台南中西區No. 28 Dade Street <a>地理位置超棒 - 顯示地圖</a></div>
            </div>
            <div className='titleRight'>
              <button className='reservationBtn'>現在就預定</button>
